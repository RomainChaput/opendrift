...
# 
# Modified: 29/04/2021. RChaput: Add settlement restricted to suitable habitat only
...
from shapely.geometry import Polygon, Point # added for settlement in polygon only
